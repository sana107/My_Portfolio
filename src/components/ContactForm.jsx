  ...
  return (
    <div className="p-16 lg:px-16 " id="contact">
      ...
      onSubmit={handleSubmit}>
        ...
        <button type="submit" className={`mb-8 w-full rounded border border-stone-50/30 bg-stone-200 py-2 text-sm font-semibold text-stone-900 hover:bg-stone-300 ${isSending ? "cursor-not-allowed opacity-50" : "" }`} disabled={isSending}>
